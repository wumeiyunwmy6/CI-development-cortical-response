import pandas as pd
import random
print("activity_clinical_2_condition_permutation")
...
for i in range(1, 101, 1):  # 将label打乱10次
    print(i)
...
pd.DataFrame(accuracy_list_per).to_csv("E:\\wumeiyun(last-first)\\method3\\clinical+speech+babble_change_permutation.csv")
