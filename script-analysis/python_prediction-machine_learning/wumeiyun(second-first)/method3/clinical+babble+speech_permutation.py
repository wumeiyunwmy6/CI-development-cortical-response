import pandas as pd
import random
print("10.19activity_clinical_2_condition_permutation")
...
pd.DataFrame(accuracy_list_per).to_csv("E:\\wumeiyun(second-first)\\method3\\clinical+babble+speech_permutation.csv")
